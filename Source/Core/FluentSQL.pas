...
begin
  ...
  FAST.ASTColumns   := nil;
  FActiveExpr := TFluentSQLCriteriaExpression.Create(FAST.Having.Expression);
  FAST.ASTTableNames := nil;
  FActiveValues := nil;
end;
...
begin
  ...
  FAST.ASTColumns := nil;
  FAST.ASTTableNames := nil;
  FActiveExpr := TFluentSQLCriteriaExpression.Create(FAST.Where.Expression);
  FActiveValues := nil;
end;
...
begin
  Result := TFluentSQLCriteriaExpression.Create(ATerm);
end;
