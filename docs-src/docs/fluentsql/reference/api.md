...
| DDL (`DROP INDEX`, ESP-025) | **`CreateFluentDDLDropIndex(ADialect, 'INDICE')`** devolve **`IFluentDDLDropIndexBuilder`**; **`AsString`** gera **`DROP INDEX`**. Ver [DDL — DROP INDEX](../guides/ddl-drop-index.md). |
