...
- Sem índices parciais, expressões em colunas, **`CONCURRENTLY`**, **`INCLUDE`**, ou opções avançadas de método de acesso (**ADR-022**). Para **`DROP INDEX`**, ver [DDL — DROP INDEX (ESP-025)](ddl-drop-index.md).
