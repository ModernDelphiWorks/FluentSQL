...
> **Release alignment:** examples and issue pointers below are reconciled with **`CHANGELOG.md`** and tag **v1.1.1** (2026-04-10).
...
- **DDL (CREATE / DROP / ALTER ADD — v1.1.0; DROP COLUMN / CREATE INDEX — v1.1.1, ESP-020 / ESP-022; DROP INDEX — ESP-025 / ESP-026):** **`Test Delphi/test.ddl.pas`** — `TTestDDLCreateTable` (**ESP-017**), `TTestDDLDropTable` (**ESP-018** / **ADR-018**), `TTestDDLAlterTableAddColumn` (**ESP-019** / **ADR-019**), `TTestDDLAlterTableDropColumn` (**ESP-020** / **ADR-020**), `TTestDDLCreateIndex` (**ESP-022** / **ADR-022**), `TTestDDLDropIndex` (**ESP-025** / **ESP-026**); incluído em **`Firebird_tests/PTestFluentSQLFirebird.dpr`**. Evidência de execução DUnitX pode depender do ambiente MSBuild/Delphi (ver issue [#32](https://github.com/ModernDelphiWorks/FluentSQL/issues/32)).
