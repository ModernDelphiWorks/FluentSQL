...
- **DDL (CREATE / DROP / ALTER ADD COLUMN):** **`Test Delphi/test.ddl.pas`** — `TTestDDLCreateTable` (**ESP-017**), `TTestDDLDropTable` (**ESP-018** / **ADR-018**), `TTestDDLAlterTableAddColumn` (**ESP-019** / **ADR-019**); incluído em **`Firebird_tests/PTestFluentSQLFirebird.dpr`**.
