...
- **DDL (CREATE / DROP TABLE):** **`Test Delphi/test.ddl.pas`** — `TTestDDLCreateTable` (**ESP-017**), `TTestDDLDropTable` (**ESP-018** / **ADR-018**); incluído em **`Firebird_tests/PTestFluentSQLFirebird.dpr`**.
